...
public class Lesson {
    ...
    private final String content; // For backward compatibility
    ...
    public Lesson(String lessonId, String courseId, String title, String description,
        ...
        this.content = description; // Use description as content
    }
    
    // Simplified constructor for backward compatibility
    public Lesson(String title, String content) {
        this(null, null, title, content, LocalDateTime.now(), 60, "Online");
    }
